...
public partial class MainWindow : Window
{
    ...
    private void Navigate(AppRoute route, Control view)
    {
        _currentRoute = route;
    ...
    {
        await _appState.FinishOnboardingAsync(questions, answers);
        ShowVaultList();
    }));
    ...
    public void ShowLoginActivity() => Navigate(AppRoute.LoginActivity, new LoginActivityView(_appState.GetLoginEvents(), ShowVaultList));
