...
/// the Android and Windows apps so a .pvbk backup exported from any of them decrypts on the
/// others. The derived key only ever wraps/unwraps the vault's real Data Encryption Key - it
/// never touches vault data directly.
/// </summary>
